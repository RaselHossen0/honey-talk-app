...
#ifndef FLUTTER_BRANCH_SDK_SWIFT_H
#define FLUTTER_BRANCH_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_branch_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18flutter_branch_sdk22FlutterBranchSdkPlugin")
@interface FlutterBranchSdkPlugin : NSObject <FlutterPlugin, FlutterSceneLifeCycleDelegate, FlutterStreamHandler>
...
- (BOOL)application:(UIApplication * _Nonnull)app openURL:(NSURL * _Nonnull)url sourceApplication:(NSString * _Nonnull)sourceApplication annotation:(id _Nonnull)annotation SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)scene:(UIScene * _Nonnull)scene willConnectToSession:(UISceneSession * _Nonnull)session options:(UISceneConnectionOptions * _Nullable)connectionOptions SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=13.0);
/// Tells the delegate to open one or more URLs.
/// This is the Scene lifecycle equivalent to application(_:open:options:)
- (BOOL)scene:(UIScene * _Nonnull)scene openURLContexts:(NSSet<UIOpenURLContext *> * _Nonnull)URLContexts SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=13.0);
...
- (BOOL)scene:(UIScene * _Nonnull)scene continueUserActivity:(NSUserActivity * _Nonnull)userActivity SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=13.0);
...
SWIFT_CLASS("_TtC18flutter_branch_sdk16LogStreamHandler")
