...
class CharmingLevelView extends GetView<CharmingLevelController> {
  const CharmingLevelView({super.key});

  static const _gradient = LinearGradient(
    colors: [Color(0xFFE91E8B), Color(0xFF9C27B0)],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CharmingLevelController>(
  ...
  Widget _buildHeader(BuildContext context, CharmingLevelController ctrl) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              EnumLocal.txtCharmingLevel.name.tr,
  ...
  Widget _buildLevelSection(CharmingLevelController ctrl) {
    return Container(
      decoration: const BoxDecoration(gradient: _gradient),
      ...
      child: Column(
        children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: AppFontStyle.styleW700(AppColor.pink, 14),
                    ),
                  ),
                ),
              ],
              ...
              Expanded(
                child: Stack(
                  ...
                  children: [
                    ...
                    Text(
                      "${CustomFormatNumber.onConvert(ctrl.currentBonus)}Bonus",
          ...
          8.height,
          Text(
            "Level up after earning ${CustomFormatNumber.onConvert(ctrl.bonusToNextLevel)} ${EnumLocal.txtBonus.name.tr}",
  ...
  Widget _buildLvRewardSection(CharmingLevelController ctrl) {
    final tabs = [
      ...
      EnumLocal.txtPlateName.name.tr,
    ];
    return Padding(
        ...
        children: [
            ...
            child: Row(
              children: tabs.map((t) => Padding(
                ...
                child: Container(
                  ...
                  child: Text(t, style: AppFontStyle.styleW500(AppColor.darkGrey, 13)),
                ),
              )).toList(),
            ),
          ),
          ...
          Row(
            ...
            children: ctrl.rewardTiers.asMap().entries.map((e) {
              final colors = [AppColor.purple, AppColor.pink, AppColor.blue];
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.favorite, color: c, size: 22),
                        2.height,
                        Text(
                          "${e.value.count}",
  ...
  Widget _buildLevelRulesSection(CharmingLevelController ctrl) {
    return Padding(
            ...
            child: Column(
              children: [
                ...
                ...ctrl.levelRules.map((r) => _levelRuleRow(
                  r.level == 0 ? "-" : "❤ ${r.level}",
                  CustomFormatNumber.onConvert(r.earnBonus ?? 0),
                )),
              ],
            ),
          ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text(EnumLocal.txtEarnBonus.name.tr, style: AppFontStyle.styleW600(AppColor.darkGrey, 13), textAlign: TextAlign.end)),
        ],
      ),
    );
  }
