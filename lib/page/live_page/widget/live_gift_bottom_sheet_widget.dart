...
class LiveGiftBottomSheetWidget {
  ...
  /// PK mode: 0 = host1, 1 = host2. When not PK mode, always host1.
  ...
  static void show({
    ...
    String? pkHost1Name,
    String? pkHost1Image,
    String? pkHost1LiveHistoryId,
    bool? pkHost1ProfilePicIsBanned,
    String? pkHost2UserId,
    String? pkHost2Name,
    String? pkHost2Image,
    String? pkHost2LiveHistoryId,
    ...
    if (isPk && pkHost1UserId != null && pkHost2UserId != null) {
      ...
      host1LiveHistoryId = pkHost1LiveHistoryId ?? liveHistoryId;
      ...
      host2LiveHistoryId = pkHost2LiveHistoryId ?? "";
      host2ProfilePicIsBanned = pkHost2ProfilePicIsBanned ?? false;
      selectedPkRecipient.value = 0;
    } else {
      host1UserId = receiverUserId;
      host1LiveHistoryId = liveHistoryId;
    }
    FetchUserCoin.init();
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              final isPk = isPkMode && host2UserId.isNotEmpty;
                              final toHost1 = !isPk || selectedPk == 0;
                              onSendGift(
                                gift: FetchCategoryWiseGiftApi.categoryWiseGift[selectedCategory]?[selectedGiftIdx],
                                liveHistoryId: isPk ? (toHost1 ? host1LiveHistoryId : host2LiveHistoryId) : liveHistoryId,
                                receiverUserId: isPk ? (toHost1 ? host1UserId : host2UserId) : receiverUserId,
                              );
                            },
                            child: Container(
                              height: 45,
...
class _PkRecipientSelector extends StatelessWidget {
  const _PkRecipientSelector({
